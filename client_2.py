...
def Main():
    ...
    data = {"action":"create",
            "title": "test_0221_python client",
            "defect_title_to_search": "test_0221_python client",
            "repro_steps":"----repro steps from client 0104 python client---",
            "priority":"2",
    ...
    # url = "http://10.71.77.70:8000"
    url = "http://10.45.41.66:8000"
