...
def createTFSBug(**kwargs):
  ...
  url = "http://tfs.cbre.com:8080/tfs/CBRE01/DevOps-Demo/_apis/wit/workitems/$Bug?api-version=1.0"
  ...
  response = session.patch(url=url,data=data_dump,headers=http_headers,auth=HttpNtlmAuth('US\\',''))
